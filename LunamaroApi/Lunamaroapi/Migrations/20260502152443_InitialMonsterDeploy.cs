...
{
    /// <inheritdoc />
    public partial class InitialMonsterDeploy : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TemporaryKey = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ...
                    OfferDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TierDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    OrderId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    UserOrderHeaderId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ItemOriginalTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ItemDiscountAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ItemFinalTotal = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Reservations_TableId_StartTime",
                table: "Reservations",
                columns: new[] { "TableId", "StartTime" },
                unique: true);
